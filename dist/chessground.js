var Chessground = (function () {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.computeSquareCenter = exports.createEl = exports.isRightButton = exports.eventPosition = exports.setVisible = exports.translateRel = exports.translateAbs = exports.posToTranslateRel = exports.posToTranslateAbs = exports.samePiece = exports.distanceSq = exports.opposite = exports.containsX = exports.timer = exports.memo = exports.allPos = exports.key2pos = exports.pos2key = exports.allKeys = exports.invRanks = void 0;
	...
	function pos2key(pos) {
	    ...
	    return exports.allKeys[bd.height * pos[0] + pos[1] - bd.height - 1];
	}
	...
	exports.allPos = exports.allKeys.map(key2pos);
	function memo(f) {
	    let v;
	    const ret = () => {
	        if (v === undefined)
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.premove = exports.advisor = exports.knight = void 0;
	...
	function premove(pieces, key) {
	    ...
	    if (!piece)
	        return [];
	    const pos = util.key2pos(key), r = piece.role, mobility = r === 'pawn' ? pawn(piece.color) : (r === 'knight' ? exports.knight : (r === 'bishop' ? bishop(piece.color) : (r === 'rook' ? rook : (r === 'cannon' ? rook : (r === 'advisor' ? advisor(piece.color) : king(piece.color))))));
	...
	function setSelected(state, key) {
	    ...
	    if (isPremovable(state, key)) {
	        state.premovable.dests = premove_1.premove(state.pieces, key);
	    }
	    else
	...
	function canPremove(state, orig, dest) {
	    return orig !== dest &&
	        ...
	        premove_1.premove(state.pieces, orig).includes(dest);
	}
	...
	function getKeyAtDomPos(pos, asWhite, bounds) {
	    ...
	    return (file > 0 && file < bd.width + 1 && rank > 0 && rank < bd.height + 1) ? util.pos2key([file, rank]) : undefined;
	}
	...
	exports.initial = 'rnbakabnr/9/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/9/RNBAKABNR w';
	const roles = { p: 'pawn', r: 'rook', n: 'knight', b: 'bishop', a: 'advisor', c: 'cannon', k: 'king' };
	        ...
	        switch (c) {
	            ...
	            default:
	                ...
	                if (nb < 58) {
	                    ...
	                    pieces.set(util.pos2key([col, row]), piece);
	                }
	        }
	    }
	    return pieces;
